        ...
        <View style={style.ViewCardUser}>
          <Surface style={style.surfaceUser} theme={DarkTheme}>
            {ResultCanPass < 80 ? (
              ...
              <View style={style.ViewPercent}>
                <Text style={{ fontSize: 20, color: "red" }}>
                  Bạn đã có khả năng vượt qua bài thi
                </Text>
                <Text style={{ fontSize: 15 }}>
                  Tỉ lệ đỗ của bạn:{" "}
        ...
        <View style={{ flexDirection: "row", flex: 1, paddingBottom: 50 }}>
          <View style={{ flex: 1 }}>
            <ButtonCustom
              ...
              subtitle="20 đề thi thử, 200 câu hỏi"
              navigate="Exam"
              image="test"
              onPress={navigation}
            />
            ...
            <ButtonCustom
              ...
              subtitle="Đây đủ biển báo giao thông"
            ...
            <ButtonCustom
              title="THỰC HÀNH"
              subtitle="Video mô phỏng thưc tế"
              navigate="Practice"
              image="rawSearch"
              onPress={navigation}
            />
          ...
          <View style={{ flex: 1 }}>
            ...
            <ButtonCustom
              ...
              subtitle="Mẹo trả lời phân theo các câu hỏi"
              navigate="TrickPass"
              image="tip"
              onPress={navigation}
            />
            ...
            <ButtonCustom
              ...
              subtitle="Lưu lại các câu bạn trả lời sai"
              navigate="FailQuestion"
              image="question"
              onPress={navigation}
            />
          </View>
