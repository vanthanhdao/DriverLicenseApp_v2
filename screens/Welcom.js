...
export default function WelcomeScreen() {
  ...
  useEffect(() => {
    ...
    imageValue.value = 0;
    setTimeout(
      () => (imageValue.value = withSpring(imageValue.value + hp(20))),
      600,
    );
    setTimeout(
    ...
    type !== ""
      ? setTimeout(() => navigation.navigate("Main_App"), 2500)
      : null;
  }, []);
  return (
    <LinearGradient
    ...
    >
      <View>
        ...
        <View>
          <Text style={{ fontSize: hp(5), textAlign: "center" }}>
            HỌC THI LÁI XE
          </Text>
        </View>
          ...
          <View style={{ alignSelf: "stretch" }}>
            ...
            >
              <TouchableOpacity onPress={() => handleChoiseType()}>
                <Text
                  style={{ fontSize: hp(2.5), padding: "5%", color: "#8BC6FC" }}
