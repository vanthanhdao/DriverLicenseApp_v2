...
const Tab = ({ navigation }) => {
              ...
              return (
                <TouchableOpacity
                  onPress={() =>
                    dispatch(
                      resetState({
                        target: ["importantQuestion", "ruleQuestion"],
                      }),
                    )
                  }
                >
  ...
  return (
    <Stack.Navigator initialRouteName="Welcom">
      ...
      <Stack.Screen
        ...
        options={{
          headerRight: () => {
            return (
              <TouchableOpacity
                onPress={() => dispatch(setVisiable({ target: "Exam" }))}
              >
      ...
      />
      <Stack.Screen
        name="ExamPracticeQues"
        component={ExamPracticeQues}
        options={{
          headerTitleAlign: "center",
          headerStyle: { backgroundColor: "#1E90FF" },
          headerTitle: "Thi sát hạch",
